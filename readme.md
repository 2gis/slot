#Slot - изоморфный javascript framework

Slot позволяет проинициализировать приложение на сервере, передеть клиенту собранную верстку и, при завершении инициализации на клиенте, привязать события к DOM-нодам.

##Быстрый старт

<Здесь будет описание про установку slot-cli и создание пустого/демо приложения>
